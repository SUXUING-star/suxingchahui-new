    ...
    <div className="w-full space-y-12 pb-20">
      <div className="px-4 home-animate">
        <div className="inline-flex flex-wrap gap-4 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[24px] shadow-xl border border-white/20">
          ...
          <select
            value={selectedTag}
            onChange={handleFilterChange(setSelectedTag)}
          ...
          {(selectedTag || selectedCategory) && (
            <button
              ...
              className="px-4 py-2 bg-red-500 text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-lg active:scale-90 transition-all"
            >
              重置
            </button>
          )}

    ...
    <div className="max-w-[1440px] mx-auto px-3 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-6">
        {posts.map((post) => (
          <div
            key={post.id}
            className="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 overflow-hidden flex flex-col hover:shadow-md transition-all"
          >
            {/* 封面图区域 - 缩小比例 */}
